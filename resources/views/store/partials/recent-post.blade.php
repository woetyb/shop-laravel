        ...
        <div class="row">
                ...
                <div class="recent-post">
                    <div class="media">
                        <a class="pull-left media-link" href="#">
                            <img class="media-object" src="/st-store/assets/img/preview/blog/recent-post-1.jpg" alt="">
            ...
            <div class="col-md-6">
                <div class="recent-post">
                    <div class="media">
                        <a class="pull-left media-link" href="#">
                            <img class="media-object" src="/st-store/assets/img/preview/blog/recent-post-2.jpg" alt="">
                            <i class="fa fa-plus"></i>
                        </a>
                        <div class="media-body">
            ...
            <div class="col-md-6">
                <div class="recent-post">
                    <div class="media">
                        <a class="pull-left media-link" href="#">
                            <img class="media-object" src="/st-store/assets/img/preview/blog/recent-post-3.jpg" alt="">
                            <i class="fa fa-plus"></i>
                        </a>
                        <div class="media-body">
            ...
            <div class="col-md-6">
                <div class="recent-post">
                    <div class="media">
                        <a class="pull-left media-link" href="#">
                            <img class="media-object" src="/st-store/assets/img/preview/blog/recent-post-4.jpg" alt="">
                            <i class="fa fa-plus"></i>
                        </a>
                        <div class="media-body">
