    ...
    <div class="container">
        <div class="top-bar-left">
            <ul class="list-inline">
                <li class="icon-user"><a href="login.html"><img src="/st-store/assets/img/icon-1.png" alt=""/> <span>Login</span></a></li>
                <li class="icon-form"><a href="login.html"><img src="/st-store/assets/img/icon-2.png" alt=""/> <span>Not a Member? <span class="colored">Sign Up</span></span></a></li>
        ...
        <div class="top-bar-right">
            <ul class="list-inline">
                ...
                <li class="dropdown flags">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="/st-store/assets/img/flag.gif" alt=""/> Eng<i class="fa fa-angle-down"></i></a>
                    <ul role="menu" class="dropdown-menu">
                        <li><a href="#"><img src="/st-store/assets/img/flag.gif" alt=""/> Eng</a></li>
                        <li><a href="#"><img src="/st-store/assets/img/flag.gif" alt=""/> Eng</a></li>
                        <li><a href="#"><img src="/st-store/assets/img/flag.gif" alt=""/> Eng</a></li>
                    </ul>
                </li>
